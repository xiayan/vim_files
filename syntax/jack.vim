" Vim syntax file
" Language:     Jack
" Maintainer:   Yan Xia revising Claudio Fleiner <claudio@fleiner.com>
" Last Change:  2012 Nov 6
...
" Support Jack keywords
syn keyword jackDeclaration    var field
syn keyword jackStatements    let constructor method function
"hi jackDeclaration ctermfg=cyan cterm=bold guifg=#00FFFF
hi jackDeclaration ctermfg=81 ctermbg=NONE cterm=NONE guifg=#66d9ef guibg=NONE gui=NONE
hi jackStatements ctermfg=197 ctermbg=NONE cterm=bold guifg=#f92672 guibg=NONE gui=bold
" to differentiate the keyword class from MyClass.class we use a match here
syn match   javaTypedef		"\.\s*\<class\>"ms=s+1
syn keyword javaClassDecl	enum
syn match   javaClassDecl	"^class\>"
syn match   javaClassDecl	"[^.]\s*\<class\>"ms=s+1
"syn match   javaBuiltinClass "\A[A-Z]\S*"
syn match   javaBuiltinClass "\v<[A-Z]+[0-9a-z]+>" 
...
"hi Type ctermfg=cyan cterm=bold guifg=#00FFFF
...
if !exists("java_ignore_javadoc") && main_syntax != 'jsp'
  ...
  "add \*\+ to accommadate /** syntax of Jack"
